...
if __name__ == '__main__':
    ...
    parser.add_argument('--questions', '-q', default='./frieda_q_bank.json',
    ...
    main(model='gemini-2.5-flash-lite',
        question_path='/projects/standard/yaoyi/pyo00005/FRIEDA-dataset/_inprog_clean/cartoreasoning/responses/response_mini.json',
