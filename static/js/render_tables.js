...
function renderCaptioningTable() {
    ...
    const captioningData = [
      { model: "GPT-4o", affiliation: "OpenAI", cider: 69.0, bleu4: 6.4, meteor: 35.9, rouge: 32.1, bert: 64.1, sbert: 66.4, gptAppearance: "3.507/5", gptAction: "3.258/5", gptEval: "3.382/5", gptEvalValue: 3.382, isBest: ["gptAppearance", "gptAction", "gptEval"], isGray: true },
      { model: "GPT-4o mini", affiliation: "OpenAI", cider: 51.1, bleu4: 2.7, meteor: 30.8, rouge: 24.0, bert: 59.3, sbert: 63.5, gptAppearance: "3.311/5", gptAction: "3.131/5", gptEval: "3.221/5", gptEvalValue: 3.221, isBest: [], isGray: true },
      { model: "Gemini 1.5 Pro", affiliation: "Google", cider: 94.8, bleu4: 11.2, meteor: 38.7, rouge: 39.0, bert: 68.5, sbert: 68.8, gptAppearance: "3.311/5", gptAction: "2.983/5", gptEval: "3.147/5", gptEvalValue: 3.147, isBest: ["bert"], isGray: false },
      { model: "Gemini 1.5 Flash", affiliation: "Google", cider: 84.3, bleu4: 7.3, meteor: 36.5, rouge: 32.9, bert: 65.3, sbert: 68.9, gptAppearance: "3.246/5", gptAction: "2.931/5", gptEval: "3.088/5", gptEvalValue: 3.088, isBest: ["sbert"], isGray: false },
      { model: "Qwen2-VL 72B", affiliation: "Alibaba", cider: 95.1, bleu4: 12.4, meteor: 40.3, rouge: 38.0, bert: 66.8, sbert: 67.5, gptAppearance: "3.324/5", gptAction: "2.791/5", gptEval: "3.057/5", gptEvalValue: 3.057, isBest: [], isGray: false },
      { model: "Qwen2-VL 7B", affiliation: "Alibaba", cider: 84.5, bleu4: 10.1, meteor: 36.9, rouge: 36.4, bert: 65.7, sbert: 66.9, gptAppearance: "3.170/5", gptAction: "2.666/5", gptEval: "2.918/5", gptEvalValue: 2.918, isBest: [], isGray: false },
      { model: "LLaVA-Video 7B", affiliation: "Bytedance & NTU S-Lab", cider: 102.6, bleu4: 14.6, meteor: 41.7, rouge: 38.8, bert: 66.7, sbert: 68.1, gptAppearance: "3.235/5", gptAction: "2.552/5", gptEval: "2.894/5", gptEvalValue: 2.894, isBest: ["meteor"], isGray: false },
      { model: "InternVL2 76B", affiliation: "Shanghai AI Lab", cider: 72.0, bleu4: 5.5, meteor: 34.2, rouge: 27.1, bert: 60.9, sbert: 65.3, gptAppearance: "3.099/5", gptAction: "2.637/5", gptEval: "2.868/5", gptEvalValue: 2.868, isBest: [], isGray: false },
      { model: "LLaVA-OneVison 7B", affiliation: "Bytedance & NTU S-Lab", cider: 86.4, bleu4: 10.0, meteor: 39.2, rouge: 32.7, bert: 63.2, sbert: 65.6, gptAppearance: "3.166/5", gptAction: "2.479/5", gptEval: "2.823/5", gptEvalValue: 2.823, isBest: [], isGray: false },
      { model: "LLaVA-Video 72B", affiliation: "Bytedance & NTU S-Lab", cider: 106.2, bleu4: 15.1, meteor: 39.8, rouge: 40.9, bert: 68.5, sbert: 68.1, gptAppearance: "3.138/5", gptAction: "2.471/5", gptEval: "2.804/5", gptEvalValue: 2.804, isBest: ["bert"], isGray: false },
      { model: "LLaVA-OneVision 72B", affiliation: "Bytedance & NTU S-Lab", cider: 107.4, bleu4: 16.1, meteor: 41.1, rouge: 41.5, bert: 68.5, sbert: 68.0, gptAppearance: "3.180/5", gptAction: "2.268/5", gptEval: "2.724/5", gptEvalValue: 2.724, isBest: ["cider", "bleu4", "rouge", "bert"], isGray: false },
      { model: "VideoChat2-Mistral", affiliation: "Shanghai AI Lab", cider: 79.0, bleu4: 6.9, meteor: 33.5, rouge: 33.5, bert: 65.4, sbert: 59.7, gptAppearance: "2.578/5", gptAction: "1.912/5", gptEval: "2.245/5", gptEvalValue: 2.245, isBest: [], isGray: false },
      { model: "InternVL2 8B", affiliation: "Shanghai AI Lab", cider: 48.4, bleu4: 2.5, meteor: 27.9, rouge: 22.6, bert: 58.2, sbert: 60.3, gptAppearance: "2.531/5", gptAction: "1.877/5", gptEval: "2.204/5", gptEvalValue: 2.204, isBest: [], isGray: false },
      { model: "MiniGPT4-Video", affiliation: "KAUST", cider: 18.4, bleu4: 0.6, meteor: 23.1, rouge: 13.2, bert: 50.7, sbert: 51.2, gptAppearance: "1.737/5", gptAction: "1.351/5", gptEval: "1.544/5", gptEvalValue: 1.544, isBest: [], isGray: false }
    ];
  ...
  function renderQATable() {
    ...
    const qaData = [
      ...
      { model: "InternVL2 76B", affiliation: "Shanghai AI Lab", objectCounting: 28.35, temporalRelationship: 45.00, action: 42.52, spatialRelationship: 38.81, appearance: 64.71, overall: 43.94, overallValue: 43.94, isBest: [] },
      { model: "VideoChat2", affiliation: "Shanghai AI Lab", objectCounting: 22.83, temporalRelationship: 31.43, action: 33.18, spatialRelationship: 38.81, appearance: 34.56, overall: 32.36, overallValue: 32.36, isBest: [] },
      { model: "InternVL2 8B", affiliation: "Shanghai AI Lab", objectCounting: 18.11, temporalRelationship: 31.43, action: 35.98, spatialRelationship: 32.09, appearance: 39.71, overall: 32.09, overallValue: 32.09, isBest: [] },
